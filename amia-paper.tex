...
\affil[1]{Informatics Institute, University of Applied Sciences Western Switzerland (HES-SO Valais-Wallis), Sierre, Switzerland}
...
\begin{longtable}{|l|p{0.3cm}|p{0.3cm}|p{0.3cm}|p{7.9cm}|}
    \caption{Table details mapping the semantic categories listed under the semantic type column to the PICO targets. Note: +1 means the concepts under this category will map matching spans to positive class label.}
